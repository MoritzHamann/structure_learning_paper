...
naechsten kapitel theoretische herleitung

	\subsection{Introduction}
	parameter schreibweise, dag, bayesian network
	
	\subsection{bayesian approach}
	formeln - parameter posterior - likelihood estimation

	\subsection{marginal likelihood}
	closed loop evaluation - parameter prior - equivalent sample size
